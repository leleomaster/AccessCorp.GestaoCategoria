...
namespace AccessCorp.GestaoCategoria.API.Providers
{
    public class AccessCorpAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        {
            var userManager = context.OwinContext.GetUserManager<UsuarioAppManager>();
